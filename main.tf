...
module "rgroup" {
  source          = "./modules/rgroup-n01579827"
  rgroup-name     = "n01579827-RG"
...
module "network" {
  source          = "./modules/network-n01579827"
...
module "common" {
  source          = "./modules/common-n01579827"
...
module "vmlinux" {
  source            = "./modules/vmlinux-n01579827"
  nb_count          = "3"
  linux-vm-name     = "vmlinux-n01579827"
  rgroup-name       = module.rgroup.az-rgroup-name.name
  rgroup-location   = module.rgroup.az-rgroup-location.location
...
module "vmwindows" {
  source         = "./modules/windows-n01579827"
  windows_name   = {
    n01579827-vm1 = "Standard_B1s"
    n01579827-vm2 = "Standard_B1ms"
  }
  win_nb_count     = "1"
  subnet_id        = module.network.azurerm_subnet_name.id
  rgroup-name      = module.rgroup.az-rgroup-name.name
...
module "datadisk" {
  source                   = "./modules/datadisk-n01579827"
  rgroup-name              = module.rgroup.az-rgroup-name.name
  rgroup-location          = module.rgroup.az-rgroup-location.location
...
module "loadbalancer" {
  source           = "./modules/loadbalancer-n01579827"
  rgroup-name      = module.rgroup.az-rgroup-name.name
  rgroup-location  = module.rgroup.az-rgroup-location.location
...
module "database" {
  source      = "./modules/database-n01579827"
  rgroup-name     = module.rgroup.az-rgroup-name.name
  rgroup-location = module.rgroup.az-rgroup-location.location
  depends_on = [
    module.rgroup
